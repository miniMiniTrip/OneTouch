...
-----------------------------------------------------------------------------------------------------
INSERT INTO product_hashtag (product_idx, hashtag_idx) VALUES
-- Product 11 (무기자차, 순한선크림, 민감선케어)
(11, 25), (11, 26), (11, 27),

-- Product 12 (수분선크림, 백탁없는선크림, 자작나무)
(12, 28), (12, 29), (12, 30),

-- Product 13 (미세먼지차단, 산뜻한선크림, 안티폴루션)
(13, 31), (13, 32), (13, 33),

-- Product 14 (남자순한선크림, 마일드선크림, 저자극선케어)
(14, 34), (14, 35), (14, 36),

-- Product 15 (남자톤업, 티안나는메이크업, 톤업로션)
(15, 37), (15, 38), (15, 39),

-- Product 16 (남자비비, 비비로션, 간편커버)
(16, 40), (16, 41), (16, 42),

-- Product 17 (남자파데, 스틱파운데이션, 커버력좋은)
(17, 43), (17, 44), (17, 45),

-- Product 18 (남자쿠션, 남성파데, 빠른화장)
(18, 46), (18, 47), (18, 48),

-- Product 19 (보송한쿠션, 헤라옴므, 남성쿠션)
(19, 49), (19, 50), (19, 51),

-- Product 20 (딥클렌징, 남자폼클렌징, 쫀쫀거품)
(20, 52), (20, 53), (20, 54),

-- Product 21 (촉촉한클렌징, 그린티, 데일리클렌징)
(21, 55), (21, 56), (21, 57),

-- Product 22 (클렌징오일, 블랙헤드제거, 남자딥클렌징)
(22, 58), (22, 59), (22, 60),

-- Product 23 (클렌징워터, 노워시클렌징, 순한세안)
(23, 61), (23, 62), (23, 63),

-- Product 24 (여드름클렌징, 트러블케어, 폼워시)
(24, 64), (24, 65), (24, 66),

-- Product 25 (클렌징젤, 피지조절, 지성피부)
(25, 67), (25, 68), (25, 69),

-- Product 26 (탄산수클렌징, 모공클렌징, 딥클렌징폼)
(26, 70), (26, 71), (26, 72),

-- Product 27 (남자각질제거, 필링젤, 마일드필링)
(27, 73), (27, 74), (27, 75),

-- Product 28 (클렌징폼, 건성클렌징, 남자보습세안)
(28, 76), (28, 77), (28, 78),

-- Product 29 (모공흡착, 화산송이, 강력세정)
(29, 79), (29, 80), (29, 81);
