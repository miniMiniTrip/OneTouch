	   ...
	   @Autowired
	    ...
	    public class ProductListController {
	        ...
	        public String productList(
	                ...
	                Model model) {
	            System.out.println("[ProductController] productLists()");
	            System.out.printf("[ProductListController] keyword: %s, category: %s, sort: %s, page: %d\n", 
	            ...
	            switch (sort) {
	                ...
	                case "price-high":
	                    ...
	                    break;
	                case "rating":
	                    map.put("orderBy", "product_idx DESC"); // 임시로 최신순
	                    break;
	                default: // popular
	            ...
	            System.out.printf("[ProductListController] 조회된 상품 수: %d, 총 페이지: %d\n", list.size(), totalPage);
	            ...
	            System.out.println("[ProductController] return /product/product_list.jsp");
	        ...
	        public String productDetail(@RequestParam("id") int productIdx, Model model) {
	            System.out.printf("[ProductListController] 상품 상세 조회: %d\n", productIdx);
	            ...
	            return "product/product_detail";  // 상품 상세 페이지
	        }
	    }
}//end
